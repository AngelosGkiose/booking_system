...
from app.models import EventModel, EventSeatModel, SeatModel, UserModel, VenueModel
from app.models.eventseat import EventSeatStatus
from app.models.reservation import ReservationModel, ReservationStatus
...
def test_cancel_reservation_returns_404_when_reservation_belongs_to_another_user():
    ...
    try:
        ...
        db.add(user1)
        db.flush()
        user2 = UserModel(email="agg@gmaildsadsa.com", hashed_password="123")
        db.add(user2)
        db.flush()
        venue = VenueModel(name="Main Venue1", address="Kristal1", city="Main City1")
        db.add(venue)
